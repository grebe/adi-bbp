...
//     maxCount: BigInt = 1L << 32,
//     addressSet: AddressSet = AddressSet(0x0, 0xFFFF),
//     beatBytes: Int = 4)(implicit valName: ValName): (AXI4StreamIdentityNode, AXI4RegisterNode) = {
//     val aligner = LazyModule(new StreamAligner(maxCount = maxCount, addressSet = addressSet, beatBytes = beatBytes)(valName = valName))
